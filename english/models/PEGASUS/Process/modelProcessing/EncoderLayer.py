...
class EncoderLayer:
    def __init__(self, model_name="google/pegasus-cnn_dailymail"):
        ...
        self.d_model = self.model.config.d_model  # Kích thước embedding
    ...
    def embedding_layer(self):
        ...
        with torch.no_grad():
            self.embeddings = self.model.model.shared(self.inputs['input_ids'])
        print("\n1️. Embedding thuần túy (Chưa thêm Positional Encoding):")
    ...
    def positional_encoding_default(self):
        ...
        with torch.no_grad():
            self.outputs_auto = self.model.model.encoder(
    ...
    def positional_encoding_custom(self, scaling_factor=0.8):
        # 2️b. Thêm Positional Encoding tùy chỉnh
